/*! AmazeUI - v1.0.0 | (c) 2014 AllMobilize, Inc. | @license MIT | 2014-07-11 21:07:40 */ /*! Sea.js 2.2.1 | seajs.org/LICENSE.md */
...
define("addon.progress", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    require("core");
    ...
    var Progress = function() {
        ...
        NProgress.render = function(fromStart) {
            ...
            var bar = progress.querySelector(Settings.barSelector), perc = fromStart ? "-100" : toBarPerc(NProgress.status || 0), spinner;
            css(bar, {
...
define("footer", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "ui.add2home", "util.cookie", "ui.dimmer" ], function(require, exports, module) {
    require("core");
    // add2home
    require("ui.add2home");
    var cookie = require("util.cookie"), dimmer = require("ui.dimmer"), $ = window.Zepto;
    $(function() {
        $(".am-footer-ysp").click(function() {
            dimmer.open(".am-switch-mode-m");
            return false;
        });
        dimmer.$element.on("click", function() {
            dimmer.close($(".am-switch-mode-m"));
        });
...
define("menu", [ "nav", "zepto.outerdemension", "zepto.extend.data", "zepto.extend.selector", "zepto.extend.fx", "core", "ui.offcanvas" ], function(require, exports, module) {
    ...
    $(function() {
        ...
        if ($(".am-menu").hasClass("am-menu-one")) {
            var This = $(".am-menu-one"), $next = $("<a>").attr({
                "class": "am-menu-next",
                href: "javascript:;"
            }), $width = 0, iNow = -1, aNum = [], $menuLv2 = $(".am-menu-lv2"), $menuLv3 = $(".am-menu-lv3");
...
define("navbar", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "qrcode", "qrcodealg", "zepto.dialog" ], function(require, exports, module) {
    require("core");
    var $ = window.Zepto;
    var qrcode = require("qrcode");
    var dialog = require("zepto.dialog");
    $(function() {
        ...
        if ($qrcode.length) {
            ...
            var qrData = $("<div id='am-navbar-boxqrcode'></div>");
            $(this).amDialog.init();
            // 初始化 am-mask
            //判断上传自定义的二维码没有，否则生成二维码
            if (qrImg) {
                qrData.html('<img src="' + qrImg + '"/>');
            } else {
        ...
        if ($share.length) {
            ...
            var shareData = '<div id="am-navbar-shareMask"></div><div class="am-navbar-boxshare"><div class="bdsharebuttonbox"><div href="#" class="bds_more" data-cmd="more">分享到</div><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间">QQ空间</a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博">新浪微博</a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博">腾讯微博</a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网">人人网</a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信">微信</a></div><a href="javascript:;" id="off">取消</a></div>';
            $body.append(shareData);
            $share.on("click", function(event) {
                $("#am-navbar-shareMask").css("display", "block");
                $(".am-navbar-boxshare").css("bottom", 0);
                return false;
            });
            $("#off").on("click", function(event) {
                $("#am-navbar-shareMask").css("display", "none");
                $(".am-navbar-boxshare").css("bottom", -292);
                return false;
            });
        }
        if ($qrcode.length) {
            ...
            $qrcode.click(function() {
                $(this).amDialog.show($("#am-navbar-boxqrcode"), "sliderDown");
                return false;
            });
            $body.click(function() {
                $(this).amDialog.hide($("#am-navbar-boxqrcode"), "sliderDown");
            });
        }
        //qrcode end
        if (_parent.length) {
...
define("paragraph", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "zepto.pinchzoom" ], function(require, exports, module) {
    ...
    $.fn.paragraphTable = function(objWidth, objHeight) {
...
define("ui.dimmer", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    require("core");
    var $ = window.Zepto, UI = $.AMUI;
    var $dimmer = $('<div class="am-dimmer" data-am-dimmer></div>'), $doc = $(document);
    var Dimmer = function() {
...
define("ui.modal", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "ui.dimmer" ], function(require, exports, module) {
    ...
    Modal.DEFAULTS = {
        /*tpl: '<div class="am-modal {{instanceClass}}{{noButtons}}" tabindex="-1">' +
         '<div class="am-modal-dialog">' +
         '{{if title}}<div class="am-modal-hd">{{title}}</div>{{/if title}}' +
         '<div class="am-modal-bd">{{content}}' +
         '{{afterContent}}' +
         '</div>' +
         '<div class="am-modal-footer">{{buttons}}</div>' +
         '</div>' +
         '</div>',
         actionTpl: '<div class="am-modal-actions">{{buttons}}</div>',
         btnOk: '确定',
         btnCancel: '取消',
         title: '',*/
        selector: {
    ...
    /*
     Modal.prototype.parseTpl = function(options) {
     ...
     buttonsHTML += '<span class="am-modal-btn' + (options.buttons[i].bold ? ' am-modal-btn-bold' : '') + '">' + options.buttons[i].text + '</span>';
     }
     }

     var modalTemplate = options.tpl;
     ...
     .replace(/{{afterContent}}/g, options.afterContent || '')
     .replace(/{{buttons}}/g, buttonsHTML)
     .replace(/{{noButtons}}/g, !options.buttons || options.buttons.length === 0 ? ' am-modal-no-btn' : '')
     .replace(/{{instanceClass}}/g, options.selector.instanceClass || '' );
     ...
     $modal.find('.am-modal-btn').each(function(i, btn) {
     $(btn).on('click', function(e) {
     if (options.buttons[i].close !== false) {
     that.close($modal[0]);
     }
     if (options.buttons[i].onClick) {
     options.buttons[i].onClick($modal[0], e);
     }
     });
     });
    ...
    Modal.prototype.close = function(relatedElement) {
        ...
        var complete = function() {
            ...
            if (isPopup) $element.removeClass("am-modal-out").hide();
            this.transitioning = 0;
        };
...
define("ui.smooth-scroll", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    ...
    // Init code
    $(document).on("click.smooth-scroll.amui", "[data-am-smooth-scroll]", function(e) {
        e.preventDefault();
        var $ele = $(this);
        $ele.smoothScroll($ele.attr("data-am-smooth-scroll").val());
    });
});
...
/**
 * Created by hzp on 14-2-24.
 */
define("zepto.dialog", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    var $ = window.Zepto;
    require("core");
    var flag = true, // 防止遮罩多次显示
    mask = $('<div class="am-mask"></div>');
    // 遮罩
    //显示效果
    var showEffect = {
        none: function(object, mask) {
            object.css({
                display: "block"
            });
            mask.css({
        ...
        sliderDown: function(object, mask) {
    ...
    $.extend($.fn, {
        amDialog: {
            ...
            show: function(object, type) {
                type = type || "none";
                showEffect[type].call(this, object, mask);
            },
            hide: function(object, type) {
                type = type || "none";
                hideEffect[type].call(this, object, mask);
            }
        }
    });
});
...
define("zepto.mask", [ "./core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    require("./core");
    var $ = window.Zepto;
    var hasMask = false, $mask = $('<div class="am-dimmer"></div>');
    var amMask = function() {
        if (!hasMask) {
            this.init();
            hasMask = true;
    ...
    $.extend(amMask.prototype, {
        ...
        show: function(element) {
            ...
            //$mask.show();
            $mask.addClass("am-active");
            $element.show();
            return this;
        },
        hide: function(element) {
            //$mask.hide();
            $mask.removeClass("am-active");
            var $element = element ? $(element) : $("");
            $element.hide();
            return this;
        },
...
seajs.use(["accordion","addon.progress","core","divider","fastclick","figure","footer","gallery","gotop","intro","list_news","map","menu","nav","navbar","pagination","paragraph","qrcode","qrcodealg","slider","sohucs","tabs","titlebar","ui.accordion","ui.add2home","ui.alert","ui.button","ui.collapse","ui.dimmer","ui.dropdown","ui.modal","ui.offcanvas","ui.popover","ui.scrollspy","ui.scrollspynav","ui.smooth-scroll","ui.sticky","util.cookie","util.fullscreen","zepto.calendar","zepto.dialog","zepto.extend.data","zepto.extend.fx","zepto.extend.selector","zepto.extend.touch","zepto.flexslider","zepto.mask","zepto.outerdemension","zepto.pinchzoom","zepto.touchgallery"]);